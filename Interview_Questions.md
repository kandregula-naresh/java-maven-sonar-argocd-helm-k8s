...
## 1 Q: Can you explain the CICD process in your current project ? or Can you talk about any CICD process that you have implemented ?
...
## 2 Q: What are the different ways to trigger jenkins pipelines ?
...
## 4 Q: How do you store/secure/handle secrets in Jenkins ?
...
## 5 Q: What is latest version of Jenkins or which version of Jenkins are you using ?
...
## 6 Q: What is shared modules in Jenkins ?
...
## 7 Q: can you use Jenkins to build applications with multiple programming languages using different agents in different stages ?
...
## 8 Q: How to setup auto-scaling group for Jenkins in AWS ?
...
## 9 Q: How to add a new worker node in Jenkins ?
...
## 10 Q: How to add a new plugin in Jenkins ?
...
## 11 Q: What is JNLP and why is it used in Jenkins ?
...
## 12 Q: What are some of the common plugins that you use in Jenkins ?

A: Be prepared for answer, you need to have atleast 3-4 on top of your head, so that interview feels you use jenkins on a day-to-day basis.

   Git Plugin: This plugin allows Jenkins to integrate with Git repositories, enabling developers to automatically build, test, and deploy their code.

Maven Plugin: This plugin integrates Jenkins with Apache Maven, a popular build automation tool used for Java projects.

Docker Plugin: This plugin allows Jenkins to build and publish Docker images as part of the CI/CD pipeline.

Pipeline Plugin: This plugin allows users to define and run their pipelines as code, providing greater flexibility and scalability.

GitHub Plugin: This plugin integrates Jenkins with GitHub, enabling developers to trigger builds and deployments based on code changes.

Slack Notification Plugin: This plugin sends notifications to a Slack channel when builds succeed or fail, allowing teams to stay up-to-date with their projects.

Ansible Plugin: This plugin integrates Jenkins with Ansible, a popular configuration management tool used to automate IT infrastructure.

JUnit Plugin: This plugin allows Jenkins to generate and display JUnit test reports, enabling developers to track their test results over time.

Email Extension Plugin: This plugin sends email notifications to specified recipients when builds succeed or fail, providing an easy way to communicate the status of a project.
